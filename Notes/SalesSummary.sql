...
Table Count:
-- AdSystem
SELECT COUNT(*) FROM tbladvertiser; -- Record Count: 22M
SELECT COUNT(*) FROM tblADScurrency_rates; -- Record Count: 19K

-- AdCentral
SELECT COUNT(*) FROM tblADCaccounts_salesrep_commissions; -- Record Count: 202M
SELECT COUNT(*) FROM tblADCadvertiser_rep_revenues; -- Record Count: 190M
SELECT COUNT(*) FROM tblADCparent_company_advertisers; -- Record Count: 13M
SELECT COUNT(*) FROM tblADCparent_company; -- Record Count: 10M
SELECT COUNT(*) FROM tblCRMgeneric_product_credit; -- Record Count: 206K
SELECT COUNT(*) FROM tblADCquota; -- Record Count: 42K
