...
--supervise \
RealTime_Load-assembly-1.0-SNAPSHOT.jar -e=prod --class=com.indeed.dataengineering.task.Generic --runClass=com.indeed.dataengineering.task.$cname $executeMode $skipMetadata --metadata.url=jdbc:postgresql://...:5432/eravana --metadata.user=aguyyala --metadata.password=... --targetFormat=parquet  --baseLoc=s3a://indeed-data/datalake/v1/stage/binlog_events --whitelistedTables=tblACLgroups,tblADCaccounts_salesrep_commissions,tblADCadvertiser_rep_revenues,tblADCcommission_adjustment,tblADCcredit_spend,tblADCdaily_advertiser_traffic,tblADCinvoice_lines,tblADCinvoices,tblADCparent_company,tblADCparent_company_advertisers,tblADCquota,tblADCsummary_advertiser,tblADCsummary_employer_action,tblADCultimate_parent,tblADCultimate_parent_association,tblADCusers_accounts,tblCRMgeneric_claims,tblCRMgeneric_invoice_requests,tblCRMgeneric_product_credit,tblCRMgeneric_products,tblCRMusers_groups_historical,tblACLusers,tbladvertiser,tblADScurrency_rates
